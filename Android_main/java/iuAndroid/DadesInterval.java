...
public class DadesInterval implements Serializable {
    ...
    public DadesInterval(final Interval inter) {
        dataInicial = inter.getPeriod().getDateInit().getTime();
        dataFinal = inter.getPeriod().getDateEnd().getTime();
        durada = inter.getPeriod().getTimeTotal()/1000;
    }
    ...
    public final String toString() {
        ...
        if (durada > 0) {
            String horesF=Long.toString(hores);
            String minutsF=Long.toString(minuts);
            String segonsF=Long.toString(segons);
            if(hores <=9){
            ...
            strdurada = horesF +":"+minutsF+":"+segonsF;

        } else {
            strdurada = "00:00:00";
        }
        return "Inici Interval: " + strdi + "\n" +"Final Interval: "+ strdf + "\nDurada: " + strdurada;
    }
